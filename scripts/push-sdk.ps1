...
# Usage with tag: .\scripts\push-sdk.ps1 -Branch main -Tag v2.6.19
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Try running: git subtree split --prefix fiddupay-node-sdk -b sdk-split; git push $RemoteUrl sdk-split:$($Branch) --force; git branch -D sdk-split" -ForegroundColor Yellow
}
