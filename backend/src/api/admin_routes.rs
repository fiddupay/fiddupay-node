...
pub fn create_admin_router(state: AppState) -> Router<AppState> {
    ...
    let public_admin_routes = Router::new().route("/api/v1/admin/login", post(admin::admin_login));
    ...
    let protected_admin_routes = Router::new()
        ...
        .route(
            ...
            get(admin::get_merchant_details),
        )
        .route(
            "/api/v1/admin/merchants/:merchant_id/suspend",
            post(admin::suspend_merchant),
        )
        .route(
            "/api/v1/admin/merchants/:merchant_id/activate",
            post(admin::activate_merchant),
        )
        .route(
            "/api/v1/admin/merchants/:merchant_id/delete",
            delete(admin::delete_merchant),
        )
        .route(
            "/api/v1/admin/merchants/:merchant_id/fee",
            put(admin::update_merchant_fee),
        )
        ...
        .route(
            ...
            get(admin::get_security_alerts),
        )
        .route(
            "/api/v1/admin/security/alerts/:alert_id/acknowledge",
            post(admin::acknowledge_alert),
        )
        .route(
        ...
        .route(
            "/api/v1/admin/config",
            axum::routing::patch(admin::update_admin_config),
        )
        .route("/api/v1/admin/config/fees", get(admin::get_fee_config))
        .route("/api/v1/admin/config/limits", get(admin::get_system_limits))
        // Smart Fee Sweeping
        .route(
            "/api/v1/admin/fee-sweep/settings",
            get(admin::get_fee_sweep_settings),
        )
        .route(
            "/api/v1/admin/fee-sweep/settings",
            put(admin::update_fee_sweep_settings),
        )
        .route(
            "/api/v1/admin/fee-sweep/trigger/:network",
            post(admin::trigger_manual_sweep),
        )
        // Admin Payment Management
        .route("/api/v1/admin/payments", get(admin::get_all_payments))
        .route(
            "/api/v1/admin/payments/:payment_id",
            get(admin::get_payment_details),
        )
        .route(
            "/api/v1/admin/payments/:payment_id/force-confirm",
            post(admin::force_confirm_payment),
        )
        .route(
            "/api/v1/admin/payments/:payment_id/force-fail",
            post(admin::force_fail_payment),
        )
        .route(
            "/api/v1/admin/transactions/reverify",
            post(admin::reverify_transaction),
        )
        ...
        .route(
            "/api/v1/admin/withdrawals/:withdrawal_id/resolve-failed-refund",
            post(admin::resolve_failed_refund),
        )
        // Admin Analytics & Reporting
        .route(
            "/api/v1/admin/analytics/platform",
            get(admin::get_platform_analytics),
        )
        .route(
            "/api/v1/admin/analytics/revenue",
            get(admin::get_revenue_analytics),
        )
        .route(
            "/api/v1/admin/reports/transactions",
            get(admin::get_transaction_reports),
        )
        .route(
            "/api/v1/admin/reports/merchants",
            get(admin::get_merchant_reports),
        )
        ...
        .route(
            ...
            delete(admin::delete_admin_user),
        )
        .route(
            "/api/v1/admin/users/:user_id/permissions",
            put(admin::update_user_permissions),
        )
        ...
        .route(
            ...
            post(admin::create_system_backup),
        )
        .route(
            "/api/v1/admin/system/maintenance",
            post(admin::toggle_maintenance_mode),
        )
