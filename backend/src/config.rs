...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            solana_rpc_url_backup: "".to_string(),
            solana_rpc_url_backup_2: "".to_string(),
            ethereum_rpc_url_backup: "".to_string(),
            bsc_rpc_url_backup: "".to_string(),
            arbitrum_rpc_url_backup: "".to_string(),
            polygon_rpc_url_backup: "".to_string(),
            solana_devnet_rpc_url_backup: "".to_string(),
            solana_devnet_rpc_url_backup_2: "".to_string(),
            ethereum_sepolia_rpc_url_backup: "".to_string(),
