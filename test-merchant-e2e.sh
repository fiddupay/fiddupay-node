...
RESPONSE=$(curl -s -X POST http://localhost:8080/api/v1/merchants/register \
...
SANDBOX_RESPONSE=$(curl -s -X POST http://localhost:8080/api/v1/merchants/api-keys/generate \
