...
import { Shield, ShieldCheck, ShieldAlert, CheckCircle2, Circle } from 'lucide-react';
            ...
            <div key={idx} className="flex items-center justify-between group">
              <div className="flex items-center gap-3">
                {item.status ? (
                  ...
                  <Circle className="w-5 h-5 text-gray-600 group-hover:text-amber-500 transition-colors" />
                )}
