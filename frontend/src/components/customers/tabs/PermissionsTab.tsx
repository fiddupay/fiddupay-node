        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
          {selectedCustomer.status !== "active" && (
            <button
              ...
              style={{
                padding: "0.75rem", border: "1px solid #d1fae5", borderRadius: "10px",
                background: "#f0fdf4", color: "#059669", fontWeight: 600, cursor: "pointer", fontSize: "0.85rem",
              }}
            >
          ...
          {selectedCustomer.status !== "flagged" && (
            <button
              ...
              disabled={statusUpdating}
              style={{
                padding: "0.75rem", border: "1px solid #fef3c7", borderRadius: "10px",
                background: "#fffbeb", color: "#d97706", fontWeight: 600, cursor: "pointer", fontSize: "0.85rem",
              }}
            >
          ...
          {selectedCustomer.status !== "suspended" && (
            <button
              ...
              disabled={statusUpdating}
              style={{
                padding: "0.75rem", border: "1px solid #fee2e2", borderRadius: "10px",
                background: "#fef2f2", color: "#dc2626", fontWeight: 600, cursor: "pointer", fontSize: "0.85rem",
              }}
            >
          ...
          {selectedCustomer.status !== "blocked" && (
            <button
              ...
              disabled={statusUpdating}
              style={{
                padding: "0.75rem", border: "1px solid #f3f4f6", borderRadius: "10px",
                background: "#f9fafb", color: "#6b7280", fontWeight: 600, cursor: "pointer", fontSize: "0.85rem",
              }}
            >
