      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p>
              PayFlow collects information necessary to provide our cryptocurrency payment services:
            </p>
          ...
          <section className={styles.section}>
            ...
            <p>
              PayFlow does not sell or rent your personal information. We may share information only in these circumstances:
            </p>
            <ul>
          ...
          <section className={styles.section}>
            ...
            <p>
              PayFlow uses cookies and similar technologies to:
            </p>
            <ul>
