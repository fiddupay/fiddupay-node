    ...
    <div className={styles.container}>
      ...
      <section className={styles.mission}>
        <div className={styles.sectionContent}>
          ...
          <p className={styles.missionText}>
            ...
            PayFlow was born from the need to bridge the gap between complex blockchain technology and everyday business operations.
          </p>
          <p className={styles.missionText}>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaContent}>
          ...
          <p>Join the businesses already using PayFlow for their cryptocurrency payments</p>
