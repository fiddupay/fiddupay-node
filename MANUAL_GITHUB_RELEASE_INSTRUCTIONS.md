# Manual GitHub Release Instructions for v2.3.6

Since GitHub CLI is not available, here are the manual steps to create the GitHub release:

## 📋 Release Information

**Repository**: https://github.com/fiddupay/fiddupay-node  
**Tag**: v2.3.6  
**Release Title**: FidduPay Node.js SDK v2.3.6 - API Centralization Release  
**Release Type**: Latest Release  

## 🚀 Manual Release Steps

### Step 1: Navigate to GitHub
1. Go to https://github.com/fiddupay/fiddupay-node
2. Click on "Releases" in the right sidebar
3. Click "Create a new release"

### Step 2: Configure Release
1. **Tag**: Select "v2.3.6" from the dropdown (already exists)
2. **Release title**: `FidduPay Node.js SDK v2.3.6 - API Centralization Release`
3. **Description**: Copy the content from `GITHUB_RELEASE_NOTES_v2.3.6.md`

### Step 3: Add Release Assets
Upload these files as release assets:
- `MIGRATION_GUIDE_v2.3.6.md`
- `CHANGELOG.md`
- `package.json`
- `RELEASE_SUMMARY_v2.3.6.md`
...
Copy this content into the GitHub release description:
...
- **[Migration Guide](https://github.com/fiddupay/fiddupay-node/releases/download/v2.3.6/MIGRATION_GUIDE_v2.3.6.md)**: Step-by-step upgrade instructions
...
- **[Examples](https://github.com/fiddupay/fiddupay-node/tree/main/examples)**: Updated code examples and use cases
...
- **Migration Guide**: [Download Migration Guide](https://github.com/fiddupay/fiddupay-node/releases/download/v2.3.6/MIGRATION_GUIDE_v2.3.6.md)
...
- **NPM Package**: https://www.npmjs.com/package/@fiddupay/fiddupay-node
- **Documentation**: https://docs.fiddupay.com
- **GitHub Repository**: https://github.com/fiddupay/fiddupay-node
